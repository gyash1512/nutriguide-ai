...
with open(r"E:\\Learning Management System\\Statistical Machine Learning\\Videos\\nutriguide\\nutriguide\\intents.json") as file:
    data = json.load(file)
...
while True:
    ...
    if result[result_index] > 0.7:
        ...
        print(f"{GREEN}{random.choice(responses)}{ENDC}")
